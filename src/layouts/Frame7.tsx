    ...
    <div className={`${className} relative w-full h-[50vh]`}>
      ...
      <div className="relative w-full h-full flex flex-col items-center z-20">
        <div className="w-full md:w-[70%]">
          <div className="flex flex-row space-x-20 items-center justify-center cursor-pointer text-white">
            <div className="w-12 h-12 border text-center align-middle">RIOT GAME</div>
            <div className="w-12 h-12 border text-center align-middle">VNG LOGO</div>
            
          </div>
          <div className="text-center text-sm px-4 md:text-lg 2xl:text-2xl space-y-2 md:space-y-6 text-white">
